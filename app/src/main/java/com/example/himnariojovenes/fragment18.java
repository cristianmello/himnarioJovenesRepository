...
public class fragment18 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =lf.inflate(R.layout.fragment_fragment18, container, false);

        TextView tvNameHimno = (TextView) view.findViewById(R.id.nameHimno18);
        TextView tvNumberHimno = (TextView) view.findViewById(R.id.numberHimno18);

        dbHelper db = new dbHelper(getActivity(), "administrar", null, 1);
        SQLiteDatabase basedeDatos = db.getWritableDatabase();

        Cursor fila = basedeDatos.rawQuery("SELECT number, name FROM himnos WHERE number LIKE '18'", null);
